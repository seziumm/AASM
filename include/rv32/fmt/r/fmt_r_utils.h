#ifndef _FMT_R_UTILS_H
#define _FMT_R_UTILS_H
...
static inline const struct instr *fmt_r_from_label(const char *label)
{
...
static inline u32 fmt_r_encode(const struct instr *e, u8 rd, u8 rs1, u8 rs2)
{
  expect(NULL != e);
  expect(e->type == FMT_R);
  struct instr c = *e;
