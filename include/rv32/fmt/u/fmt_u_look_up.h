#ifndef _FMT_U_LOOK_UP_H
#define _FMT_U_LOOK_UP_H
...
static inline u32 fmt_u_encode(struct instr *e, u8 rd, u32 imm20)
{
  expect(NULL != e);
  expect(e->type == FMT_U);
...
static inline const struct instr *fmt_u_look_up(const char *label)
{
